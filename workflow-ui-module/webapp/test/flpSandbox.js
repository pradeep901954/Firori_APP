		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Collage Approval ",
									"targetURL": "#CollagePradeepworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"CollagePradeepworkflowuimodule-display": {
								"semanticObject": "CollagePradeepworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=CollagePradeep.workflowuimodule",
									"url": sap.ui.require.toUrl("CollagePradeep/workflowuimodule")
								}
							}
						}
					}
